...
public:
  ...
  void arb_sumas(Arbre<int>  &asum)  {
      node_arbre* n;
      int x=0;
      suma(primer_node,n,x);
      asum.primer_node=n;
  }
  void suma(node_arbre* a,node_arbre* & n, int& x){
      if (a->segD == NULL and a->segE == NULL){
          x=a->info;
          n=new node_arbre;
          n->info=x;
          n->segD =NULL;
      ...
      a1 = (a->segE);
      a2 = (a->segD);
      if (a->segE != NULL) suma(a1,n1,x1);
      if (a->segD != NULL) suma(a2,n2,x2);
      n=new node_arbre;
      n->segE=n1;
      n->segD=n2;
      n->info= (a->info) + x1 + x2;
